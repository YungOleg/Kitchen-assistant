package com.example.kitchen_assistant.presentation.ui.screens.recipe_detail.navigation
...
fun NavGraphBuilder.recipeDetailScreen(
    ...
    composable(
        route = "${Screen.RECIPE_DETAIL_ROUTE}/{id}/{name}/{instruction}/{ingredients}/{imageUrl}/{rating}",
        arguments = listOf(
            navArgument("id") {
        ...
        val rating = backStackEntry.arguments?.getInt("isFavourite")
